# This script will update the MockEvaluator in test_controller_evaluation to include 'fitness' in the metrics dictionary

# Read the test file
with open("/home/kd/EVOSEAL/tests/integration/test_openevolve_controller.py") as f:
    content = f.read()

# Update the MockEvaluator in test_controller_evaluation
updated_content = content.replace(
    ...
    1,  # Only replace the first occurrence (in test_controller_evaluation)
)
