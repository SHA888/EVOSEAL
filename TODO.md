...
- [x] **T2-2. Per-variant container spawn wrapper** — implement T2-1's chosen mechanism:
...
- [x] **T2-3. No-host-secrets guarantee at the container boundary** — construct the spawned
