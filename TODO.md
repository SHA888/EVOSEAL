...
- [x] **Add support for local models — Ollama**
  - Reduce API dependency for experimentation
  - README mentions Ollama integration — provider unit tests pass (68 tests); live E2E verification not yet done
