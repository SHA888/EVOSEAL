...
"""
        ...
        doc_suggestions = [s for s in suggestions 
...
"""
        ...
        class_suggestions = [s for s in suggestions 
...
"""
        ...
        module_suggestions = [
            ...
            if s.metadata.get("node_type") == "module"
        ]
...
"""
        ...
        return_suggestions = [
            s for s in suggestions 
            if "return type hint" in s.explanation.lower()
        ]
...
"""
        ...
        param_suggestions = [
            s for s in suggestions 
            if "parameter 'param1'" in s.explanation
        ]
    ...
    def test_empty_docstring(self, strategy):
        ...
        empty_doc_suggestions = [s for s in suggestions 
                              if "Empty docstring" in s.explanation]
...
"""
        ...
        args_suggestions = [
            s for s in suggestions 
            if "Missing 'Args' section" in s.explanation
        ]
...
"""
        ...
        returns_suggestions = [
            s for s in suggestions 
            if "Missing 'Returns' section" in s.explanation
        ]
    ...
    def test_long_docstring_line(self, strategy):
        ...
        long_line = " " * 80 + "This is a very long line that exceeds the default 88 character limit."
...
'''
        ...
        long_line_suggestions = [
            s for s in suggestions 
            if "Docstring line too long" in s.explanation
        ]
