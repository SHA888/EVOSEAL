...
class TestContextFilter(unittest.TestCase):
    ...
    def test_filter_with_context(self):
        ...
        self.assertEqual(self.record.user_id, 'test_user')
        self.assertEqual(self.record.request_id, '12345')
    ...
    def test_request_id(self):
        ...
        self.assertEqual(self.record.request_id, 'req_123')
...
class TestDecorators(unittest.TestCase):
    ...
    def test_with_request_id(self, mock_logging, mock_uuid):
        ...
        mock_logger.info.assert_any_call(
            "Starting request test-request-id",
            extra={'request_id': 'test-request-id'}
        )
        mock_logger.info.assert_any_call(
            "Completed request test-request-id",
            extra={'request_id': 'test-request-id'}
        )
