...
class ModelVersionManager:
    ...
    def __init__(self, versions_dir: Optional[Path] = None):
        ...
        logger.info(f"ModelVersionManager initialized with {len(self.registry.get('versions', []))} versions")
    ...
    def _load_registry(self) -> Dict[str, Any]:
        ...
        if self.registry_file.exists():
            try:
                ...
                return {"versions": [], "current_version": None, "created": datetime.now().isoformat()}
        else:
            return {"versions": [], "current_version": None, "created": datetime.now().isoformat()}
    ...
    async def register_version(
        ...
        try:
            ...
            version_info = {
                ...
                "performance_metrics": self._extract_performance_metrics(training_results, validation_results)
            }
